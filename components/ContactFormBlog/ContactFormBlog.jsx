...
import styles from './ContactFormBlog.module.scss';
...
export const ContactFormBlog = ({ onSubmitSuccess, buttonText, onMessageVisibility, subject }) => {
  ...
  const onSubmit = async (values, { resetForm }) => {
    try {
      ...
      await axios.post('/api/contactblog', { ...values, subject }); // Отправляем данные формы на сервер
